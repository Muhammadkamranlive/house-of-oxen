    ...
    return ( 
        <>
         <aside class="col-lg-4">
            {/* <!-- Sidebar--> */}
            <div class="offcanvas offcanvas-collapse bg-white w-100 rounded-3 shadow-lg py-1" id="shop-sidebar" style={{maxWidth: "22rem"}}>
                ...
                <div class="widget">
                  ...
                  <div class="d-flex flex-wrap">
                    <div class="form-check form-option text-center mb-2 mx-1" style={{width: "4rem"}}>
                      ...
                      <label class="form-option-label rounded-circle" for="color-blue-gray"><span class="form-option-color rounded-circle" style={{backgroundColor: "#b3c8db"}}></span></label>
                    ...
                    <div class="form-check form-option text-center mb-2 mx-1" style={{width: "4rem"}}>
                      ...
                      <label class="form-option-label rounded-circle" for="color-burgundy"><span class="form-option-color rounded-circle" style={{backgroundColor: "#ca7295"}}></span></label>
                    ...
                    <div class="form-check form-option text-center mb-2 mx-1" style={{width: "4rem"}}>
                      ...
                      <label class="form-option-label rounded-circle" for="color-teal"><span class="form-option-color rounded-circle" style={{backgroundColor: "#91c2c3"}}></span></label>
                    ...
                    <div class="form-check form-option text-center mb-2 mx-1" style={{width: "4rem"}}>
                      ...
                      <label class="form-option-label rounded-circle" for="color-brown"><span class="form-option-color rounded-circle" style={{backgroundColor: "#9a8480"}}></span></label>
                    ...
                    <div class="form-check form-option text-center mb-2 mx-1" style={{width: "4rem"}}>
                      ...
                      <label class="form-option-label rounded-circle" for="color-coral-red" ><span class="form-option-color rounded-circle" style={{backgroundColor: "#ff7072"}}></span></label>
                    ...
                    <div class="form-check form-option text-center mb-2 mx-1" style={{width: "4rem"}}>
                      ...
                      <label class="form-option-label rounded-circle" for="color-navy"><span class="form-option-color rounded-circle" style={{backgroundColor: "#696dc8"}}></span></label>
                    ...
                    <div class="form-check form-option text-center mb-2 mx-1" style={{width: "4rem"}}>
                      ...
                      <label class="form-option-label rounded-circle" for="color-charcoal"><span class="form-option-color rounded-circle" style={{backgroundColor: "#4e4d4d"}}></span></label>
                    ...
                    <div class="form-check form-option text-center mb-2 mx-1" style={{width: "4rem"}}>
                      ...
                      <label class="form-option-label rounded-circle" for="color-sky-blue"><span class="form-option-color rounded-circle" style={{backgroundColor: "#8bcdf5"}}></span></label>
